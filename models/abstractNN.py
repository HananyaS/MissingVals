...
class AbstractNN(nn.Module, AbstractModel):
    ...
    def fit(
        ...
        for epoch in range(1, n_epochs + 1):
            ...
            val_auc = self.evaluate(
                loader=val_loader, metric=metric, labels_from_loader=labels_from_loader
            )
    ...
    def predict(
        ...
        self.eval()
        preds = torch.Tensor([]).view(-1, self.get_num_classes() if probs else 1)
    ...
    def _eval_auc(
        ...
        return roc_auc_score(labels_, preds)
